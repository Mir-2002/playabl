  ...
  return (
    <div className="min-h-screen bg-background bg-dots">
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        {/* Single profile container — header / stats / activity divided into
            sections so the profile reads distinctly from the home dashboard. */}
        <div className="bg-white border-2 border-foreground rounded-2xl shadow-hard-lg animate-pop-in overflow-hidden">
          {/* Header — responsive, no overlap at 390px */}
          ...
          {/* Stats — flat inline blocks (not nested cards) */}
          <div className="grid sm:grid-cols-2 border-t-2 border-foreground/10 divide-y-2 sm:divide-y-0 sm:divide-x-2 divide-foreground/10">
            <div className="p-6 sm:p-8">
              <div className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded-full border-2 border-foreground bg-primary flex items-center justify-center">
              ...
              <p className="font-heading font-extrabold text-4xl text-foreground mt-3 leading-none">
                {profile.total_points > 0 ? profile.total_points.toLocaleString() : "0"}
              </p>
            ...
            <div className="p-6 sm:p-8">
              <div className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded-full border-2 border-foreground bg-[#F472B6] flex items-center justify-center">
          ...
          {/* Activity heatmap */}
          <div className="p-6 sm:p-8 border-t-2 border-foreground/10">
